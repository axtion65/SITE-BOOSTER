...
function StatusBadge({ status }: { status: string }) {
  switch (status) {
    ...
    case "narrating":
      return (
        <span className="inline-flex items-center px-2 py-0.5 rounded-md text-[9px] font-black tracking-widest uppercase bg-sky-500/20 text-sky-300 border border-sky-500/30 backdrop-blur-md">
          Voiceover
        </span>
      );
    case "failed":
